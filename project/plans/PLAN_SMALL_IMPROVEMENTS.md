...
- [ ] 4. UI tones too saturated — should follow hue from secondary/tertiary but use grey saturation
- [ ] 5. For custom theme, use primary saturation / 10 for UI tone saturation
- [ ] 6. Updating complementary colors should update UI tone with muted saturation

## Group C — Step 2 Top Panel
- [ ] 7. Same padding as step 1, narrower swatches fitting 100%, radio group for UI tones with button appearance (no gaps, no radio dots, rounding only first/last)

## Group D — Bezier & Dark Mode
- [ ] 8. Bezier input grid lines and handle lines too bright — make 2 steps darker
- [ ] 9. Dark mode background: chosen UI-tone swatch 800 with 500 grid lines
