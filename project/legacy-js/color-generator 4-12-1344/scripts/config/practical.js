(function (root) {
    ...
    const PRACTICAL_TONE_PRESET = Object.freeze({
        rust: { hue: 0, light: 25, dark: -3, saturation: 0.1 },
        coffee: { hue: 30, light: 23, dark: -13, saturation: 0.1 },
        brass: { hue: 60, light: 13, dark: -20, saturation: 0.1 },
        moss: { hue: 90, light: -14, dark: -6, saturation: 0.1 },
        olive: { hue: 120, light: -7, dark: 9, saturation: 0.1 },
        kelp: { hue: 150, light: 0, dark: 13, saturation: 0.1 },
        stone: { hue: 180, light: 8, dark: 4, saturation: 0.1 },
        slate: { hue: 210, light: 11, dark: 0, saturation: 0.1 },
        smoke: { hue: 240, light: 7, dark: 1, saturation: 0.1 },
        rebecca: { hue: 270, light: 0, dark: 0, saturation: 0.1 },
        mauve: { hue: 300, light: -6, dark: 4, saturation: 0.1 },
        clay: { hue: 330, light: -13, dark: 9, saturation: 0.1 }
    });
