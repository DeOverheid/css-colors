...
#### 2. **HSL Lightness Adjustments Panel** (Priority: HIGH)
...
#### Task 1.2: Hue-Based Lightness Adjustment
- [ ] Create `stepLightnessAdjustment.ts` composable
- [ ] Create `LightnessAdjustmentPanel.vue` component
- [ ] Port adjustment algorithm from `lightness-adjustment.js`
- [ ] Add Step 3.5 or integrate into Step 3
- [ ] Apply adjustments in `HueSpectrumRow.vue`
